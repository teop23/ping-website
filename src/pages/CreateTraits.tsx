  ...
  return (
    <div className="flex-grow bg-gradient-to-br from-gray-50 to-gray-100 p-2 sm:p-4 w-full min-h-0 flex flex-col">
      <div className="max-w-7xl mx-auto w-full flex flex-col h-full">
        ...
        <div className="flex flex-col lg:flex-row gap-3 sm:gap-6 w-full mb-6 flex-1 min-w-0 overflow-hidden">
          ...
          <motion.div
            ...
            className="w-full lg:flex-1 lg:flex-shrink lg:flex-grow min-w-0"
          >
            <CanvasArea
              canvasRef={canvasRef}
